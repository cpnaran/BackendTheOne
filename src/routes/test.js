...
import { BarcodeFormat, BinaryBitmap, BrowserMultiFormatReader, BrowserQRCodeReader, DecodeHintType, HybridBinarizer, MultiFormatReader, RGBLuminanceSource } from '@zxing/library';
...
router.post("/", async (req, res) => {
    ...
    const img = await uploadFile("F:/Work_space/TheOneProject/SCBQR.png");
    res.json(img)
